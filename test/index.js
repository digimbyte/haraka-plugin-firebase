...
beforeEach(function (done) {
  this.plugin = new fixtures.plugin('firebase')
...
describe('load_firebase_ini', function () {
  it('loads firebase.ini from config/firebase.ini', function (done) {
    this.plugin.load_firebase_ini()
